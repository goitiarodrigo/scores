...
const ModalLogin = ({isOpen, setIsOpen, setIsLogged}: IProps) => {
  ...
  return (
    <div className="modal-login">
        ...
        <input autoComplete="false" type="email" className="input" placeholder="Usuario" name="user" value={logUser.user} onChange={(e) => setLogUser({...logUser, [e.target.name]: e.target.value})} />
